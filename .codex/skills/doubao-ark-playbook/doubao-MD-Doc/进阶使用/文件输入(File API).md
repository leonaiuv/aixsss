...
```mixin-react
return (<Tabs>
<Tabs.TabPane title="Curl" key="X9WE5eDA4K"><RenderMd content={`\`\`\`Bash
...
<Tabs.TabPane title="Python SDK" key="OZFhshk9MN"><RenderMd content={`\`\`\`Python
import os
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Go SDK" key="Q1kBdpnh6k"><RenderMd content={`\`\`\`Go
package main
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Java SDK" key="yeFNhoAtOX"><RenderMd content={`\`\`\`Java
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="兼容 OpenAI SDK" key="XFKbk0c8VJ"><RenderMd content={`\`\`\`Python
import os
...
```mixin-react
return (<Tabs>
<Tabs.TabPane title="Curl" key="ERyRyAcXPI"><RenderMd content={`\`\`\`Bash
curl https://ark.cn-beijing.volces.com/api/v3/files/file-20251014**** \\
-H "Authorization: Bearer $ARK_API_KEY"
\`\`\`

`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Python SDK" key="PFj8esI6LK"><RenderMd content={`\`\`\`Python
import os
from volcenginesdkarkruntime import Ark
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Go SDK" key="YbSNJfscqx"><RenderMd content={`\`\`\`Go
package main
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Java SDK" key="Fpe4cHFJAX"><RenderMd content={`\`\`\`Java
package com.ark.sample;
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="兼容 OpenAI SDK" key="qSVbbK5GDh"><RenderMd content={`\`\`\`Python
import os
from openai import OpenAI
...
```mixin-react
return (<Tabs>
<Tabs.TabPane title="Curl" key="exGuGy0QBg"><RenderMd content={`\`\`\`Bash
curl https://ark.cn-beijing.volces.com/api/v3/files \\
-H "Authorization: Bearer $ARK_API_KEY"
\`\`\`

`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Python SDK" key="M5KD0n03xl"><RenderMd content={`\`\`\`Python
import os
from volcenginesdkarkruntime import Ark
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Go SDK" key="mHrAKZTlPs"><RenderMd content={`\`\`\`Go
package main
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Java SDK" key="lCLMY7rhDX"><RenderMd content={`\`\`\`Java
package com.ark.sample;
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="兼容 OpenAI SDK" key="ltg92XaTow"><RenderMd content={`\`\`\`Python
import os
from openai import OpenAI
...
上传成功的文件默认存储7天，可以通过 **expire_at** 参数自定义存储有效期，取值范围为1\-30天。文件超过存储有效期后会自动删除，参数设置请参见[上传文件](https://www.volcengine.com/docs/82379/1870405)。
同时支持通过 Files API 删除已上传的文件，使用示例如下：

```mixin-react
return (<Tabs>
<Tabs.TabPane title="Curl" key="QZEc65Z45y"><RenderMd content={`\`\`\`Bash
curl https://ark.cn-beijing.volces.com/api/v3/files/file-20251014**** \\
-X DELETE \\
-H "Authorization: Bearer $ARK_API_KEY"
\`\`\`
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Python SDK" key="ed88K5qH9U"><RenderMd content={`\`\`\`Python
import os
from volcenginesdkarkruntime import Ark
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Go SDK" key="r4bQXCXoFr"><RenderMd content={`\`\`\`Go
package main
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Java SDK" key="cv3HucQFrS"><RenderMd content={`\`\`\`Java
package com.ark.sample;
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="兼容 OpenAI SDK" key="XDM5Ef3Sod"><RenderMd content={`\`\`\`Python
import os
from openai import OpenAI
...
针对文件较大或需在多次请求中重复使用该文件的场景，建议通过 Files API 上传文件，然后在 Responses API 中使用 File ID 的方式实现多模态理解。具体示例参见 [视频理解](/docs/82379/1585128#4cf7f2d7)、[图片理解](/docs/82379/1585128#8ce138a2)、[文档理解](/docs/82379/1585128#9e6be380)。
上传文件后，需等待文件处理完成后（即 **status** 为 active 时）才能在 Responses API 中使用对应的 File ID 进行分析。下面是视频理解的示例代码。

```mixin-react
return (<Tabs>
<Tabs.TabPane title="Curl" key="oEdbZhUb7l"><RenderMd content={`1. 上传视频文件获取File ID。
   \`\`\`Bash
   curl https://ark.cn-beijing.volces.com/api/v3/files \\
   -H "Authorization: Bearer $ARK_API_KEY" \\
   -F 'purpose=user_data' \\
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Python SDK" key="YuBa2De1hn"><RenderMd content={`\`\`\`Python
import asyncio
import os
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Go SDK" key="BHxnpweaGK"><RenderMd content={`\`\`\`Go
package main
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Java SDK" key="zrUmPLIBSE"><RenderMd content={`\`\`\`Java
package com.ark.sample;
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="兼容 OpenAI SDK" key="Shrm6kozWC"><RenderMd content={`\`\`\`Python
import os
import time
from openai import OpenAI
...
Files API QPS限流及带宽限制如下。如果需要提升限流值，请提交[申请工单](https://console.volcengine.com/workorder/create?step=2&SubProductID=P00001166)。
