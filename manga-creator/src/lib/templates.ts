...
export const BUILT_IN_TEMPLATES: PromptTemplate[] = [
  // 场景描述模板
  {
    ...
    name: '写实场景描述',
    category: '场景描述',
    description: '适合写实风格的场景描述，注重光影和细节',
    template: `请为以下分镜生成写实风格的场景描述：
...
请开始描述：`,
  ...
  },
  {
    ...
    name: '动漫场景描述',
    category: '场景描述',
    description: '适合日系动漫风格的场景描述',
    template: `请为以下分镜生成动漫风格的场景描述：
...
请开始描述：`,
  ...
  },
  {
    ...
    name: '赛博朋克场景',
    category: '场景描述',
    description: '赛博朋克风格场景，强调科技感和霓虹光效',
    template: `请为以下分镜生成赛博朋克风格的场景描述：

分镜概要：{{summary}}

要求：
1. 强调霓虹灯、全息投影等科技元素
2. 描述未来都市的高楼大厦和阴暗小巷的对比
3. 融入电子屏幕、数据流等视觉符号
4. 雨天、夜晚、烟雾等氛围元素
5. 长度控制在150-200字
