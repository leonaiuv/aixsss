...
```mixin-react
return (<Tabs>
<Tabs.TabPane title="Python" key="qvVkmKcOgB"><RenderMd content={`\`\`\`Python
import asyncio
import os
...
<Tabs.TabPane title="Go" key="rm98nfNlbB"><RenderMd content={`\`\`\`Go
package main
import (
    "context"
    "fmt"
...
```mixin-react
return (<Tabs>
<Tabs.TabPane title="Curl" key="xUQdFNxCyo"><RenderMd content={`\`\`\`Bash
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Python" key="qXVWIsvOZw"><RenderMd content={`\`\`\`Python
import os
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Go" key="vCzRfmczk7"><RenderMd content={`\`\`\`Go
package main
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Java" key="xZKjFrIwic"><RenderMd content={`\`\`\`Java
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="OpenAI SDK" key="IoDO3R3e6Q"><RenderMd content={`\`\`\`Python
import os
...
```mixin-react
return (<Tabs>
<Tabs.TabPane title="Curl" key="LgMi2LMqkb"><RenderMd content={`\`\`\`Bash
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Python" key="Tlt5lvlNVm"><RenderMd content={`\`\`\`Python
import base64
import os
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Go" key="kxLR41ERzc"><RenderMd content={`\`\`\`Go
package main
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Java" key="bLyyxQOLHF"><RenderMd content={`\`\`\`Java
package com.ark.sample;
...
```mixin-react
return (<Tabs>
<Tabs.TabPane title="Curl" key="gq4SxOHEQB"><RenderMd content={`\`\`\`Bash
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Python" key="G1x0Fa7Uv3"><RenderMd content={`\`\`\`Python
import os
from volcenginesdkarkruntime import Ark
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Go" key="cLwoxPnSLP"><RenderMd content={`\`\`\`Go
package main
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Java" key="K5qK76ODcf"><RenderMd content={`\`\`\`Java
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="OpenAI SDK" key="ISd4RO66tz"><RenderMd content={`\`\`\`Python
import os
from openai import OpenAI
...
```mixin-react
return (<Tabs>
<Tabs.TabPane title="Curl" key="cd9iAPhM4q"><RenderMd content={`\`\`\`Bash
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Python" key="Nc0NkphzDr"><RenderMd content={`\`\`\`Python
import os
# Install SDK:  pip install 'volcengine-python-sdk[ark]'
from volcenginesdkarkruntime import Ark
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Go" key="b4HKKYNwza"><RenderMd content={`\`\`\`Go
package main
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Java" key="qrcl3hxdxy"><RenderMd content={`\`\`\`Java
package com.ark.sample;
...
```mixin-react
return (<Tabs>
<Tabs.TabPane title="Curl" key="pgKjQLnBAb"><RenderMd content={`\`\`\`Bash
curl https://ark.cn-beijing.volces.com/api/v3/chat/completions \\
   -H "Content-Type: application/json"  \\
   -H "Authorization: Bearer $ARK_API_KEY"  \\
   -d '{
...
* 按需替换 Model ID，查询 Model ID 参见 [模型列表](/docs/82379/1330310)。
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Python" key="EJUVibAzUm"><RenderMd content={`\`\`\`Python
import os
# Install SDK:  pip install 'volcengine-python-sdk[ark]'
from volcenginesdkarkruntime import Ark
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Go" key="wdFBnC4FsX"><RenderMd content={`\`\`\`Go
package main
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Java" key="pVBugVcIQD"><RenderMd content={`\`\`\`Java
package com.ark.sample;
...
public class MultiImageSample {
  ...
  public static void main(String[] args) throws Exception {
    ...
    // se builder mode for the second image
    contentParts.add(ChatCompletionContentPart.builder()
         .type("image_url")
         .imageUrl(new ChatCompletionContentPartImageURL(
...
- 缺省时生效：**image_pixel_limit** 字段的 **min_pixels** / **max_pixels** 字段未设置，则使用 **detail** 默认值配置所对应的值。具体范围参见[图片像素及 token 用量说明](/docs/82379/1362931#f141b9ef)。
...
通过`detail`参数来控制模型理解图片的精细度，返回速度，token用量，计费公式请参见[图片像素及 token 用量说明](/docs/82379/1362931#f141b9ef)。

- `low`：“低分辨率”模式，`doubao-seed-1.8`之前的模型默认值为此模式。处理速度会提高，适合图片本身细节较少或者只需模型理解图片大致信息或者对速度有要求的场景。
- `high`：“高分辨率”模式，`doubao-seed-1.8` 模型默认值为此模式。模型可感知图片更多的细节，但是处理图片速度会降低，适合图像像素值高且需关注细节信息的场景，如街道地图分析等。

不在对应模式的相应范围的图片，方舟会等比例缩放至范围内。

```mixin-react
return (<Tabs>
<Tabs.TabPane title="Curl" key="FcWRSk0LlX"><RenderMd content={`\`\`\`Bash
curl https://ark.cn-beijing.volces.com/api/v3/chat/completions \\
   -H "Content-Type: application/json" \\
   -H "Authorization: Bearer $ARK_API_KEY" \\
   -d '{
...
* 按需替换 Model ID，查询 Model ID 参见 [模型列表](/docs/82379/1330310)。
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Python" key="a9dBMbfbt8"><RenderMd content={`\`\`\`Python
import os
# Install SDK:  pip install 'volcengine-python-sdk[ark]'
from volcenginesdkarkruntime import Ark
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Go" key="qraGfnCc7h"><RenderMd content={`\`\`\`Go
package main
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Java" key="mowG89WZyE"><RenderMd content={`\`\`\`Java
package com.ark.sample;
...
```mixin-react
return (<Tabs>
<Tabs.TabPane title="Curl" key="Y2teVuiZjh"><RenderMd content={`\`\`\`Bash
curl https://ark.cn-beijing.volces.com/api/v3/chat/completions \\
   -H "Content-Type: application/json" \\
   -H "Authorization: Bearer $ARK_API_KEY" \\
   -d '{
...
* Model ID: [模型列表](/docs/82379/1330310)。
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Python" key="PKjWxba8bl"><RenderMd content={`\`\`\`Python
import os
# Install SDK: pip install 'volcengine-python-sdk[ark]'
from volcenginesdkarkruntime import Ark
...
```mixin-react
return (<Tabs>
<Tabs.TabPane title="Curl" key="rsUlEbB8Yp"><RenderMd content={`\`\`\`Bash
curl https://ark.cn-beijing.volces.com/api/v3/chat/completions \\
   -H "Content-Type: application/json" \\
   -H "Authorization: Bearer $ARK_API_KEY" \\
   -d '{
...
* Model ID: [模型列表](/docs/82379/1330310)。
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Python" key="bum26hH6K4"><RenderMd content={`\`\`\`Python
import os
# Install SDK:  pip install 'volcengine-python-sdk[ark]'
from volcenginesdkarkruntime import Ark
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Go" key="JocJTLnKby"><RenderMd content={`\`\`\`Go
package main
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Java" key="ESxXWFfFe2"><RenderMd content={`\`\`\`Java
package com.ark.sample;
...
```mixin-react
return (<Tabs>
<Tabs.TabPane title="Python " key="DTgFaOyPN3"><RenderMd content={`\`\`\`Python
import asyncio
import os
from volcenginesdkarkruntime import AsyncArk
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Go" key="u6AugKb2TS"><RenderMd content={`\`\`\`Go
package main
...
<span aceTableMode="list" aceTableWidth="1,1,2,2"></span>
|对比项 ||`doubao-seed-1.8` 之前的模型|`doubao-seed-1.8`模型|\
| | |> detail默认值为`low` |> detail默认值为`high` |
|---|---|---|---|
|传入图片像素要求 ||_ 宽 \> 14px 且高 \> 14px||\
| | |_ 宽\*高范围：[196px, 36000000px] | |
|图片token用量估算逻辑 ||`Bash|`Bash|\
| | |min(image*width * image*hight ÷ 784, max_image_tokens)|min(image_width * image_hight ÷ 1764, max_image_tokens)|\
| | |`|`|\
| | | | |
|图片缩放规则 ||不在low、high模式对应的图片像素区间时，方舟会等比例缩放至范围内。 ||
|`detail:low`模式 |图片像素区间|[3136, 1048576] |[1764, 2139732] |\
| |[min_pixels, max_pixels] | | |
|^^|单图token范围 |[4, 1312] |[1, 1213] |
|`detail:high`模式 |图片像素区间|[3136, 4014080] |[1764, 9031680] |\
| |[min_pixels, max_pixels] | | |
|^^|单图token范围 |[4, 5120] |[1, 5120] |

<span id="91a5b467"></span>

### 图片像素说明

1. 传入图片像素要求：具体限制见[图片像素及 token 用量说明](/docs/82379/1362931#f141b9ef)，传入的图片超出限制后会直接报错。
2. 图片预处理：根据使用的模型、设置的 detail 模式，将图片等比例缩放至相应的范围（具体见[图片像素及 token 用量说明](/docs/82379/1362931#f141b9ef)），可降低模型响应时延及 token 消耗。

<span id="57188ace"></span>

### token 用量说明

根据图片宽高像素计算得到 token 用量。不同模型的图片 token 用量计算逻辑、单图 token 范围参见[图片像素及 token 用量说明](/docs/82379/1362931#f141b9ef)。
