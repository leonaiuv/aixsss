...
export const CreateSceneInputSchema = z.object({
  ...
  sceneScriptJson: z.unknown().optional(),
  soundDesignJson: z.unknown().optional(),
  transitionInJson: z.unknown().optional(),
  transitionOutJson: z.unknown().optional(),
  shotLanguageJson: z.unknown().optional(),
