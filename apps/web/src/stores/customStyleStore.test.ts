...
describe('customStyleStore', () => {
  ...
  describe('updateCustomStyle', () => {
    it('应该更新自定义画风', () => {
      const { createCustomStyle, updateCustomStyle, getCustomStyleById } = useCustomStyleStore.getState();
  ...
  describe('deleteCustomStyle', () => {
    it('应该删除自定义画风', () => {
      const { createCustomStyle, deleteCustomStyle, getCustomStyleById } = useCustomStyleStore.getState();
